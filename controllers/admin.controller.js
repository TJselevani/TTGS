...
const adminPage = async (req, res) => {
    ...
    res.render('admin', {title: 'Admin', name: user.name, 
    message: '', lecturerInfo: lecInfo, timetableData: tTable ? tTable.unitss : []});
}
...
const getSemesters = async (req, res) => {
    ...
    res.render('admin', {title: 'Admin', name: 'req.user.name', message: '', lecturerInfo: lecInfo, timetableData: tTable ? tTable.unitss : []});  
}
